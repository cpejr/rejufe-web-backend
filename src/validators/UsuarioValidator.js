...
module.exports = {
  create: celebrate({
    ...
    [Segments.BODY]: Joi.object().keys({
      ...
      allocation: Joi.string().valid('TRF', 'CEARÁ', 'RIO GRANDE DO NORTE', 'PARAÍBA', 'PERNAMBUCO', 'ALAGOAS', 'SERGIPE').required(),
  ...
  update: celebrate({
    ...
    [Segments.BODY]: Joi.object().keys({
      ...
      allocation: Joi.string().valid('TRF', 'CEARÁ', 'RIO GRANDE DO NORTE', 'PARAÍBA', 'PERNAMBUCO', 'ALAGOAS', 'SERGIPE').insensitive(),
      acting: Joi.string(),
      personal_cep: Joi.string(),
      personal_address: Joi.string(),
